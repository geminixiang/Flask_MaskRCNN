...
model_file = "./models/27cls_500x30_all_20.h5"
try:
    import time, stat
...
def index():
    ...
    resp = make_response(render_template('index.html', imgs=results, model=model_file, model_modify_time=model_modify_time))
