...
def save_images(image, image_name, boxes, masks, class_ids, scores, class_names, filter_classs_names=None,scores_thresh=0.1, save_dir=None, mode=0):
    """
        image: image array
...
def color_splash(image, mask):
    ...
    gray = sk_color.gray2rgb(sk_color.rgb2gray(image)) * 255
